...
int dataflow_register_native_ops(Dataflow_Handle * dataflow_handle) {
	...
	int num_moe_base_funcs = 4;
	char * moe_base_names[] = {"default_prepare_expert_zone", "default_merge_expert_result", "default_router_bwd_x", "default_router_gate_bwd_x"};
	...
	DataflowDatatype moe_dt_combos[4][1][2] = {{{DATAFLOW_BF16, DATAFLOW_BF16}}, {{DATAFLOW_BF16, DATAFLOW_BF16}}, {{DATAFLOW_BF16, DATAFLOW_BF16}}, {{DATAFLOW_BF16, DATAFLOW_BF16}}};

	// [base_funcs][moe_funcs_per_base[i]]
	char * moe_dt_str_combos[4][1] = {{"bf16_bf16"}, {"bf16_bf16"}, {"bf16_bf16"}, {"bf16_bf16"}};
