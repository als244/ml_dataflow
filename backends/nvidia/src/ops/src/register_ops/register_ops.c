...
int dataflow_register_native_ops(Dataflow_Handle * dataflow_handle) {
	...
	int num_moe_base_funcs = 6;
	char * moe_base_names[] = {"default_prepare_expert_zone", "default_prepare_experts", "default_merge_expert_result", "default_merge_experts", "default_router_bwd_x", "default_router_gate_bwd_x"};

	int num_moe_funcs_per_base[] = {1, 1, 1, 1, 1, 1};

	moe_base_register_skeleton_func moe_base_register_skeleton_funcs[] = {dataflow_set_default_prepare_expert_zone_skeleton, dataflow_set_default_prepare_experts_skeleton, dataflow_set_default_merge_expert_result_skeleton, dataflow_set_default_merge_experts_skeleton, dataflow_set_default_router_bwd_x_skeleton, dataflow_set_default_router_gate_bwd_x_skeleton};
	char * moe_init_symbols[] = {NULL, NULL, NULL, NULL, NULL, NULL};

	// [base_funcs][moe_funcs_per_base[i]][2]
	DataflowDatatype moe_dt_combos[6][1][2] = {{{DATAFLOW_BF16, DATAFLOW_BF16}}, {{DATAFLOW_BF16, DATAFLOW_BF16}}, {{DATAFLOW_BF16, DATAFLOW_BF16}}, {{DATAFLOW_BF16, DATAFLOW_BF16}}, {{DATAFLOW_BF16, DATAFLOW_BF16}}, {{DATAFLOW_BF16, DATAFLOW_BF16}}};

	// [base_funcs][moe_funcs_per_base[i]]
	char * moe_dt_str_combos[6][1] = {{"bf16_bf16"}, {"bf16_bf16"}, {"bf16_bf16"}, {"bf16_bf16"}, {"bf16_bf16"}, {"bf16_bf16"}};
