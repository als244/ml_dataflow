...
template<>
void run_bwd_agg_expanded_kv_<120, __half>(cudaStream_t stream, 
    ...
    bwd_agg_expanded_kv_fp16<120><<<grid, block, smem_size, stream>>>(num_seqs, k_seq_offsets, k_seq_lens, 
