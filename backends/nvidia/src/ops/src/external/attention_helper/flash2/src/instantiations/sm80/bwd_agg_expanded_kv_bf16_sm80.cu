...
template<>
void run_bwd_agg_expanded_kv_<80, __nv_bfloat16>(cudaStream_t stream, 
    ...
    bwd_agg_expanded_kv_bf16<80><<<grid, block, smem_size, stream>>>(num_seqs, k_seq_offsets, k_seq_lens, 
