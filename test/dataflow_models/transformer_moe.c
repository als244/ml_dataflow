	...
	#define TO_PRINT_FWD_WAITING 1
	#define TO_PRINT_BWD_WAITING 1
	#define TO_PRINT_ACT_WAITING 1
	#define TO_PRINT_OPT_STEP_WAITING 1

	#define TO_PRINT_GRAD_BLOCK_WAITING 1
	#define TO_PRINT_FWD_ACT_WAITING 1
