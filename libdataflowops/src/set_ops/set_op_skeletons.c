...
int dataflow_set_op_skeleton(Op_Skeleton * skeleton, char * op_name, DataflowDatatype fwd_dt, DataflowDatatype bwd_dt) {
	...
	else if (strcmp(op_name, "default_rms_norm_recompute") == 0) {
		dataflow_set_default_rms_norm_recompute_skeleton(skeleton, fwd_dt);
	}
	...
	*/
	...
	else if (strcmp(op_name, "default_set_average_loss") == 0) {
		dataflow_set_default_set_average_loss_skeleton(skeleton);
	}
	else {
...
void dataflow_set_default_rms_norm_recompute_skeleton(Op_Skeleton * skeleton, DataflowDatatype fwd_datatype){
	...
	sprintf(op_nickname, "%s_%s", "default_rms_norm_recompute", dataflow_datatype_as_string(fwd_datatype));
...
void dataflow_set_default_set_average_loss_skeleton(Op_Skeleton * skeleton) {
...
void dataflow_set_default_prepare_experts_skeleton(Op_Skeleton * skeleton, DataflowDatatype attn_datatype, DataflowDatatype expert_datatype){

	Op_Skeleton_Header * skeleton_header = &(skeleton -> header);

	char op_nickname[MAX_OP_NICKNAME_SIZE];

	sprintf(op_nickname, "%s_%s_%s", "default_prepare_experts", dataflow_datatype_as_string(attn_datatype), dataflow_datatype_as_string(expert_datatype));
	...
	arg_dtypes[1] = DATAFLOW_INT_SCALAR;
	arg_dtypes[2] = DATAFLOW_INT_SCALAR;
	arg_dtypes[3] = attn_datatype;
	arg_dtypes[4] = DATAFLOW_INT;
	arg_dtypes[5] = expert_datatype;
...
void dataflow_set_default_merge_experts_skeleton(Op_Skeleton * skeleton, DataflowDatatype attn_datatype, DataflowDatatype expert_datatype){

	Op_Skeleton_Header * skeleton_header = &(skeleton -> header);

	char op_nickname[MAX_OP_NICKNAME_SIZE];

	sprintf(op_nickname, "%s_%s_%s", "default_merge_experts", dataflow_datatype_as_string(attn_datatype), dataflow_datatype_as_string(expert_datatype));	
...
void dataflow_set_default_router_bwd_x_skeleton(Op_Skeleton * skeleton, DataflowDatatype attn_datatype, DataflowDatatype expert_datatype){
	...
	sprintf(op_nickname, "%s_%s_%s", "default_router_bwd_x", dataflow_datatype_as_string(attn_datatype), dataflow_datatype_as_string(expert_datatype));
	...
	arg_dtypes[5] = DATAFLOW_INT;
	arg_dtypes[6] = DATAFLOW_INT;
	arg_dtypes[7] = DATAFLOW_UINT16;
	arg_dtypes[8] = DATAFLOW_FP32;
	arg_dtypes[9] = expert_datatype;
	arg_dtypes[10] = attn_datatype;
	arg_dtypes[11] = attn_datatype;
	arg_dtypes[12] = expert_datatype;
...
void dataflow_set_default_router_gate_bwd_x_skeleton(Op_Skeleton * skeleton, DataflowDatatype attn_datatype, DataflowDatatype expert_datatype) {

	Op_Skeleton_Header * skeleton_header = &(skeleton -> header);

	char op_nickname[MAX_OP_NICKNAME_SIZE];

	sprintf(op_nickname, "%s_%s_%s", "default_router_gate_bwd_x", dataflow_datatype_as_string(attn_datatype), dataflow_datatype_as_string(expert_datatype));
