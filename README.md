...
- ***Optimizing for performance***: Custom-built solutions targeting a specific computing environment (specific architectures, known: # of acccelerators, bandwidths, memory capacities, etc)
    - Lacks portability
