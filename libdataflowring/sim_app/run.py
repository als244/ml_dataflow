...
def parse_parameters(form_data):
    ...
    params['min_chunk_size'] = form_data.get('min_chunk_size', default=16384, type=int)
    params['num_rings'] = form_data.get('num_rings', default=8, type=int)
    params['N'] = form_data.get('N', default=16, type=int)
    params['num_seqs'] = form_data.get('num_seqs', default=100, type=int)
    ...
    params['num_experts'] = form_data.get('num_experts', default=256, type=int)
    params['active_experts'] = form_data.get('active_experts', default=9, type=int)
    params['expert_dim'] = form_data.get('expert_dim', default=2048, type=int)
